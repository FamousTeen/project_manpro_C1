                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
                                        ...
                                        <div id="anggotaSection" class="hidden">
                                            <form class="space-y-4" id="anggotaForm">
                                                ...
                                                <div>
                                                    ...
                                                    <select name="anggotaId" id="namaAnggota" class="block appearance-none w-full p-2 border border-gray-300 rounded-md bg-white">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1 relative">
                                                        <select name="roles" id="tugasAnggota" class="block appearance-none w-full p-2 border border-gray-300 rounded-md bg-white">
                    ...
                    <script>
                        ...
                        function addAnggota() {
                            ...
                            if (nama && (tugas || tugasSelect.value !== 'custom')) {
                                const tableBody = document.getElementById('anggotaTableBody');

                                // Extract the name part only (before the first ' - ')
                                const [name] = nama.split(' - ');
                                ...
                                const [nameOnly, wilayah] = nama.split(' - ');
        ...
        `;
                        ...
                        function updateRowNumbers() {
                            ...
                            Array.from(tableBody.rows).forEach((row, index) => {
                                row.cells[0].textContent = `${index + 1}.`; // Update first cell with the new number
                            });
                        }
