...
<div class="container mx-auto py-8 mt-8">
    <div class="p-6 mb-8 bg-[#f6f1e3] border border-[#002366] shadow-lg">
        ...
        <div class="flex flex-col items-center justify-center space-x-4 mt-8 mx-8 md:flex-row">
            ...
            <span class="hidden md:inline">atau</span>
            <!-- Drag and Drop Area -->
            <div id="dropArea" class="hidden md:block w-full h-40 border-dashed border-2 border-gray-300 rounded flex items-center justify-center p-4 cursor-pointer" ondrop="handleFileDrop(event)" ondragover="event.preventDefault()">
                <div class="text-center flex flex-col items-center mt-4"> <!-- Added flex-col for vertical alignment -->
