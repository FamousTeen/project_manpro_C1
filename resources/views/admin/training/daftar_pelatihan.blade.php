...
<div class="container-fluid content-body mx-12 ">
    ...
    <div class="flex justify-between">
        ...
        <div class="bg-white flex px-4 border-b border-[#333] focus-within:border-b-blue-500 overflow-hidden max-w-md me-3">
        ...
        <div class="my-6 rounded-xl py-6 pe-6 ms-5 flex bg-[#f6f1e3]">
            <div class="flex justify-between w-full">
                ...
                <div class="flex items-end justify-end space-x-2 mt-4">
                    <a href="{{route('trainings.edit', ['training' => $training])}}"><button type="button" class="px-6 py-2 bg-[#002366] hover:bg-[#20252f] text-white rounded-lg">Edit</button></a>
                    <div class="">
                        <form class="mb-0" action="{{route('trainings.destroy', ['training' => $training])}}" method="post">
                            @csrf
                            @method('delete')
                            <button type="submit" class="px-4 py-2 bg-[#ae0001] hover:bg-[#740001] text-white rounded-lg">
                                Delete</button>
                        </form>
                    </div>
                </div>
