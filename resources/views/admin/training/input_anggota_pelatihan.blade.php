...
@section('content')
    ...
    <header class="mt-16 p-8">
        <div class="grid">
            ...
            <!-- Input Button -->
            <button id="addButton" class="px-6 py-2 bg-[#002366] hover:bg-[#20252f] text-white rounded-lg justify-self-end">+
                Add</button>
        </div>
    ...
    <div class="bg-[#f6f1e3] rounded-lg shadow-lg p-6 mx-16 mb-8 misa-card">
        ...
        <div class="flex justify-end space-x-4 mt-4">
            <button id="editButton1" class="px-6 py-2 bg-[#002366] hover:bg-[#20252f] text-white rounded-lg">Edit</button>
    ...
    <div id="editModal1" class="hidden fixed inset-0 flex justify-center items-center bg-gray-800 bg-opacity-50 z-50">
        <div class="bg-[#f6f1e3] p-8 rounded-lg shadow-lg w-96">
    ...
    <script>
        ...
        editButton1.addEventListener('click', () => {
            editModal1.classList.remove('hidden');
