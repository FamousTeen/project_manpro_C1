...
<header class="container mx-auto mt-20">
    <div class="grid">
        ...
        <!-- Input Button -->
        <button id="addButton" class="mr-4 px-6 py-2 mb-4 bg-[#002366] hover:bg-[#20252f] text-white rounded-lg justify-self-end">+ Add Group</button>
    </div>
</header>
...
<div class="bg-[#f6f1e3] rounded-lg shadow-lg p-6 mx-16 mb-8 misa-card">
    <div class="flex flex-col md:flex-row justify-between">
        <!-- Group Name -->
        <div class="flex-1 basis-1/4 mb-4 md:mb-0">
