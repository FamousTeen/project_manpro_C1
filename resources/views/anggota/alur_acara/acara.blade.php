...
<div class="flex justify-center mb-16">
  <div class="grid grid-cols-1 md:grid-cols-3 gap-16 ">
    ...
    <div class="bg-[#f6f1e3] p-6 shadow-lg w-auto mx-8 border border-[#002366]">
      <img src="../../images/contoh_poster.jpg" alt="Poster Acara" class="mx-auto w-64" />
      <p class="text-center text-sm mt-2">28 September 2024</p>
    </div>
    <!-- Poster 3 -->
    <div class="bg-[#f6f1e3] p-6 shadow-lg w-auto mx-8 border border-[#002366]">
      <img src="../../images/contoh_poster.jpg" alt="Poster Acara" class="mx-auto w-64" />
      <p class="text-center text-sm mt-2">29 September 2024</p>
    </div>

    <!-- Poster 4 -->
    <div class="bg-[#f6f1e3] p-6 shadow-lg w-auto mx-8 border border-[#002366]">
      <img src="../../images/contoh_poster.jpg" alt="Poster Acara" class="mx-auto w-64" />
      <p class="text-center text-sm mt-2">30 September 2024</p>
    </div>
    <!-- Poster 5 -->
    <div class="bg-[#f6f1e3] p-6 shadow-lg w-auto mx-8 border border-[#002366]">
      <img src="../../images/contoh_poster.jpg" alt="Poster Acara" class="mx-auto w-64" />
      <p class="text-center text-sm mt-2">1 October 2024</p>
    </div>
    <!-- Poster 6 -->
    <div class="bg-[#f6f1e3] p-6 shadow-lg w-auto mx-8 border border-[#002366]">
      <img src="../../images/contoh_poster.jpg" alt="Poster Acara" class="mx-auto w-64" />
      <p class="text-center text-sm mt-2">2 October 2024</p>
    </div>
  </div>
</div>
