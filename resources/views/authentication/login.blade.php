  ...
  <div class="container-fluid h-dvh content-center w-dvw">
    <form class="max-w-md m-auto p-14 pb-5 bg-[#C4CDC1] rounded-lg">
      ...
      <div class="relative mt-14 z-0 w-full mb-5 group">
        <a href="{{ route('dashboard_admin')}}" type="submit"
          class="inline-block text-white bg-[#2F575D] hover:bg-[#103A38] focus:ring-4 focus:outline-none focus:ring-[#0A3431] font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-[#2F575D] dark:hover:bg-[#103A38] dark:focus:ring-[#0A3431]">Login</a>
      </div>
