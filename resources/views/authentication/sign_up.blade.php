...
<body class="bg-[#DEE1DD]">
    <div class="container-fluid h-full content-center w-full my-6">
        <form method="POST" action="{{ route('store_account') }}"
            class="max-w-lg m-auto p-14 pb-5 bg-[#C4CDC1] rounded-lg" enctype="multipart/form-data">
            @csrf
          ...
          aria-describedby="
                    user_avatar_help" id="photo" name="photo" type="file">
            </div>
            ...
            <div class="relative mt-14 z-0 w-full mb-5 group">
                <button type="submit"
                    class="text-white bg-[#2F575D] hover:bg-[#103A38] focus:ring-4 focus:outline-none focus:ring-[#0A3431] font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-[#2F575D] dark:hover:bg-[#103A38] dark:focus:ring-[#0A3431]">Create
                    Account</button>
            </div>
